...
Answer.create!([{answer: "Answer1_Question1_Test1",question_id: questions[0].id, correct: true},
                ...
                {answer: "Answer2_Question2_Test1",question_id: questions[1].id, correct: false},
                ...
                {answer: "Answer2_Question2_Test2",question_id: questions[3].id, correct: false},
                ...
                {answer: "Answer2_Question2_Test3",question_id: questions[5].id, correct: false}])
